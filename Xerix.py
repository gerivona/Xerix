...
class Hashes:
    ...
    md5, sha256 and sha512
        ...
        input_hash = input(
            "Enter the hash type (md5, sha256, sha512): ").strip().lower()
    ...
    try:
        while True:
            ...
            if cmd.startswith('hash'):
                ...
                print(
                    "Command not recognized. Enter 'help' for the list of the avaliable commands "
                )
                continue
        ...
        try:
            if cmd2 == 'l' or cmd2 == "L":
                ...
                Log_pass = getpass.getpass(
                    prompt="Enter your password:").strip()
            ...
            print(
                "You must create an account first. Enter C to create an account"
            )
